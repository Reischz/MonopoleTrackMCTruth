...
void xsec() {
  ...
  c1->SetLogy();
  std::string lu="ptfs_LUXqed_plus_PDF4LHC15_nnlo_100_mass_xsec-pb.log";
  std::string nn="ptfs_NNPDF31_nlo_as_0118_luxqed_mass_xsec-pb.log";
  std::string df="ptfs_nn23lo1_mass_xsec-pb.log";
