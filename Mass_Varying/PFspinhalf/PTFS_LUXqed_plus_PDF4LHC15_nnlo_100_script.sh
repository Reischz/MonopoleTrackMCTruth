...
pdf_id="82000"
current_dir=$(pwd)
gen_card="PTFS_LUXqed_plus_PDF4LHC15_nnlo_100_gen_card"
launch_card="PTFS_LUXqed_plus_PDF4LHC15_nnlo_100_launch_card"


echo -e "set lhapdf /work/app/lhapdf/6.5.4/bin/lhapdf-config\nimport model mono_spinhalf_beta" > $gen_card
