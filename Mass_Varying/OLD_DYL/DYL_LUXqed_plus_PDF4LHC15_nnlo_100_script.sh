...
pdf_name="LUXqed_plus_PDF4LHC15_nnlo_100"
config_name="DYL_${pdf_name}"
pdf_id="82000"
current_dir=$(pwd)
gen_card="DYL_LUXqed_plus_PDF4LHC15_nnlo_100_gen_card"
launch_card="DYL_LUXqed_plus_PDF4LHC15_nnlo_100_launch_card"


echo -e "set lhapdf /work/app/lhapdf/6.5.4/bin/lhapdf-config\nimport model mono_spinzero" > $gen_card
echo -e "generate p p > a > mm+ mm-\noutput ${config_name}" >> $gen_card
